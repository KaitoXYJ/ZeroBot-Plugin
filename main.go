...
import (
	...
	//                                                                  //
	//                             自制插件区                             //
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/reboot"   // 重启
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/batool"   // batool
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/randpic"  // 随机图片
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/rsshub"   // rsshub
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/scumtool" // scumtool
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/movies" // 电影
	//                             自制插件区                             //
	//                                                                  //
	//                                                                  //
	//                                                                  //
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "小月", "Set default nickname.")
	prefix := flag.String("p", "月儿", "Set command prefix.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "小月"),
...
func main() {
	...
	// 帮助
	zero.OnFullMatchGroup([]string{"/help777", ".help777", "菜单777"}, zero.OnlyToMe).SetBlock(true).
